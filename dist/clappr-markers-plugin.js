...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _clappr=__webpack_require__(1);__webpack_require__(24);var _marker=__webpack_require__(3);var _marker2=_interopRequireDefault(_marker);var _standardMarker=__webpack_require__(21);var _standardMarker2=_interopRequireDefault(_standardMarker);var _imageMarker=__webpack_require__(20);var _imageMarker2=_interopRequireDefault(_imageMarker);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var MarkersPlugin=function(_UICorePlugin){_inherits(MarkersPlugin,_UICorePlugin);_createClass(MarkersPlugin,[{key:'name',get:function get(){return'markers-plugin';}},{key:'attributes',get:function get(){return{'class':this.name};}}],[{key:'Marker',get:function get(){return _marker2.default;}},{key:'StandardMarker',get:function get(){return _standardMarker2.default;}},{key:'ImageMarker',get:function get(){return _imageMarker2.default;}// backwards compatibility
	},{key:'default',get:function get(){return MarkersPlugin;}}]);function MarkersPlugin(core){_classCallCheck(this,MarkersPlugin);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(MarkersPlugin).call(this,core));_this._markers=[];_this._createInitialMarkers();return _this;}_createClass(MarkersPlugin,[{key:'bindEvents',value:function bindEvents(){this.listenTo(this.core.mediaControl,_clappr.Events.MEDIACONTROL_RENDERED,this._onMediaControlRendered);this.listenTo(this.core.mediaControl,_clappr.Events.MEDIACONTROL_CONTAINERCHANGED,this._onMediaControlContainerChanged);}/*
	   * Add a new marker.
	   ...
	   */},{key:'removeMarker',value:function removeMarker(marker){var internalMarker=null;var index=0;this._markers.some(function(a){if(a.source===marker){internalMarker=a;return true;}index++;return false;});if(!internalMarker){return false;}return this._removeInternalMarker(internalMarker,index);}},{key:'_removeInternalMarker',value:function _removeInternalMarker(internalMarker,index){internalMarker.$marker.remove();internalMarker.emitter.off("timeChanged",internalMarker.timeChangedHandler);if(internalMarker.$tooltipContainer){internalMarker.$tooltipContainer.remove();}if(internalMarker.tooltipChangedHandler){internalMarker.emitter.off("tooltipChanged",internalMarker.tooltipChangedHandler);}internalMarker.onDestroy();this._markers.splice(index,1);return true;}/*
	   * Clear all existing markers
	   */},{key:'clearMarkers',value:function clearMarkers(){var self=this;if(!this._markers){return;}// Create a copy of the array since you cannot iterate and remove all its members correctly at the same time
	var markersCopy=this._markers.slice(0);markersCopy.forEach(function(marker,index){self._removeInternalMarker(marker,index);});}/*
	   * Get all markers
	   */},{key:'getAll',value:function getAll(){return this._markers;}/*
	   * Get marker by index. Can be used with removeMarker call to remove a marker by index
	   */},{key:'getByIndex',value:function getByIndex(index){if(!this._markers||index>this._markers.length||index<0){return null;}return this._markers[index];}},{key:'_bindContainerEvents',value:function _bindContainerEvents(){if(this._oldContainer){this.stopListening(this._oldContainer,_clappr.Events.CONTAINER_TIMEUPDATE,this._onTimeUpdate);this.stopListening(this._oldContainer,_clappr.Events.CONTAINER_MEDIACONTROL_SHOW,this._onMediaControlShow);}this._oldContainer=this.core.mediaControl.container;this.listenTo(this.core.mediaControl.container,_clappr.Events.CONTAINER_TIMEUPDATE,this._onTimeUpdate);this.listenTo(this.core.mediaControl.container,_clappr.Events.CONTAINER_MEDIACONTROL_SHOW,this._onMediaControlShow);}},{key:'_getOptions',value:function _getOptions(){if(!("markersPlugin"in this.core.options)){throw"'markersPlugin' property missing from options object.";}return this.core.options.markersPlugin;}// build a marker object for internal use from the provided Marker
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _clappr=__webpack_require__(1);var _marker=__webpack_require__(3);var _marker2=_interopRequireDefault(_marker);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var BaseMarker=function(_Marker){_inherits(BaseMarker,_Marker);function BaseMarker(time){_classCallCheck(this,BaseMarker);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(BaseMarker).call(this));_this._time=time;_this._$marker=_this._buildMarkerEl();_this._$tooltip=null;return _this;}/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _eventEmitter=__webpack_require__(19);var _eventEmitter2=_interopRequireDefault(_eventEmitter);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var assign=__webpack_require__(6),normalizeOpts=__webpack_require__(13),isCallable=__webpack_require__(9),contains=__webpack_require__(16),d;d=module.exports=function(dscr,value/*, options*/){var c,e,w,options,desc;if(arguments.length<2||typeof dscr!=='string'){options=value;value=dscr;dscr=null;}else{options=arguments[2];}if(dscr==null){c=w=true;e=false;}else{c=contains.call(dscr,'c');e=contains.call(dscr,'e');w=contains.call(dscr,'w');}desc={value:value,configurable:c,enumerable:e,writable:w};return!options?desc:assign(normalizeOpts(options),desc);};d.gs=function(dscr,get,set/*, options*/){var c,e,options,desc;if(typeof dscr!=='string'){options=set;set=get;get=dscr;dscr=null;}else{options=arguments[3];}if(get==null){get=undefined;}else if(!isCallable(get)){options=get;get=set=undefined;}else if(set==null){set=undefined;}else if(!isCallable(set)){options=set;set=undefined;}if(dscr==null){c=true;e=false;}else{c=contains.call(dscr,'c');e=contains.call(dscr,'e');}desc={get:get,set:set,configurable:c,enumerable:e};return!options?desc:assign(normalizeOpts(options),desc);};

/***/ },
/* 6 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';module.exports=__webpack_require__(7)()?Object.assign:__webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';module.exports=__webpack_require__(11)()?Object.keys:__webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';module.exports=__webpack_require__(17)()?String.prototype.contains:__webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=/media/community/clappr-markers-plugin/node_modules/compass-mixins/lib!./style.sass", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=/media/community/clappr-markers-plugin/node_modules/compass-mixins/lib!./style.sass");
